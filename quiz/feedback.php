...
<div class="col-md-10">
<a href="mailto:chiraggoel.53784@gmail.com" style="color:#000000">naresh2dev@gmail.com / nishanthbhushan05@gmail.com</a><br /><br />
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/Naresh.jpeg" width=100 height=100 alt="Naresh D" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="http://www.linkedin.com/in/naresh-dev" style="color:#202020; font-family:'typo' ; font-size:18px" title="Click to View Profile">Naresh D</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 7010746740</h4>
		<h4 style="font-family:'typo' ">naresh2dev@gmail.com</h4>
		<h4 style="font-family:'typo' ">Panimalar Engineering College, Chennai</h4></div></div>


		<div class="row">
		<div class="col-md-4">
		 <img src="image/Nishanth.jpeg" width=100 height=100 alt="Nishanth Bhushan C" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="http://www.linkedin.com/in/nishant-bhushan-a6849016b" style="color:#202020; font-family:'typo' ; font-size:18px" title="Click to View Profile">Nishanth Bhushan C</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 9600167716</h4>
		<h4 style="font-family:'typo' ">nishanthbhushan05@gmail.com</h4>
		<h4 style="font-family:'typo' ">Panimalar Engineering College, Chennai</h4></div></div>
		</p>
      </div>
